      ...
      <ScrollArea className="flex-1 min-h-0">
        <div className="space-y-4 p-4">
          ...
          {nodeType === 'telegramAlert' && (<>
            <div className="space-y-2"><Label className="text-xs">ZeroTouchAlgo Username</Label><Input className="h-8" placeholder="Your login ID" value={(nodeData.username as string) || ''} onChange={(e) => handleDataChange('username', e.target.value)} /></div>
