    ...
    if (searchQuery) {
      const filtered = users.filter(
        (user) =>
          ...
          user.zerotouch_username?.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  return (
    <div className="py-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold">{users.filter((u) => u.zerotouch_username).length}</p>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>ZeroTouchAlgo Account</TableHead>
                ...
                {filteredUsers.length === 0 ? (
                  ...
                  filteredUsers.map((user) => (
                    <TableRow key={user.telegram_id}>
                      ...
                      <TableCell>
                        {user.zerotouch_username ? (
                          <Badge variant="outline">{user.zerotouch_username}</Badge>
                        ) : (
